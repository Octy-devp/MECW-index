---
id: MECW29-016
title: "Appendix: Index to the 7 Notebooks"
volume: 29
doc_type: article
status: raw
---
...
(Steuart VII, 26, 27) {Gouge VII, 27) (VII, 30, 31) (32, 33, 34). Bailey (VII, 36). Müller (I.e.). The Economist (VII, 38). Assignats (VII, 35). Livres de compte[1] in France (Gamier, I.e.). Money as measure needs no constancy of value, only quantity (Bailey VII, 36). Urquhart VII, 55. Gray (VII, 57). Fullarton VII, 61.
...
Fixing the money of account (Müller VII, 36) (VII, 38). Depreciation of the STANDARD (VII, 55 Morrison).
...
(47) (marchandise[6] becomes denrée[7] money as means of circulation does not).
