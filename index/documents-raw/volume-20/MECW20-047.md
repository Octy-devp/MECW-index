---
id: MECW20-047
title: "Synopsis of Capital, Volume I"
volume: 20
doc_type: article
...
on the one hand, as definite productive activity, weaving labour, tailoring labour, etc. — "useful labour"; on the other, as the simple expenditure of human labour-power, precipitated abstract (general) labour. The former produces use-value, the latter exchange-value; only the latter is quantitatively comparable (the differences between skilled and unskilled, composite and simple labour confirm this).
