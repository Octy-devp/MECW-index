---
id: MECW08-087
title: "The Berlin National-Zeitung to the Primary Electors"
volume: 8
doc_type: article
author: Karl Marx
written: "25 January 1849"
year: 1849
publication: "Source: Marx-Engels Collected Works, Volume 8, p. 271; Written: by Marx between January 25 and 27, 1849; First published: in *Neue Rheinische Zeitung* No. 205 and No. 207 (second edition), January 26 "
status: raw
---

*Cologne,* January 25. Although rarely, it does happen from time to time that one has the pleasure of seeing a signpost of the good old pre-March times rising out of the alluvial deposit which the double deluge of revolution and counter-revolution has left behind. Mountains have been shifted, valleys have been filled up, and forests levelled to the ground, but the signpost still stands in its old place, painted in the old colours, and still bearing the old inscription: "To Schilda!"[1]
...
"The hour has come when the Prussian people is about to exercise for the second time its hard-won universal suffrage" (as if the so-called universal suffrage, granted from above, with its different interpretation in each village, were the same suffrage as that of April 8! )[2], "from which are to come the men who for the second time have to declare what is the spirit (!), the opinion (!!) and the will (!!!) not of separate social estates and classes, but of the whole people."
...
Nothing learnt and nothing forgotten![3]
